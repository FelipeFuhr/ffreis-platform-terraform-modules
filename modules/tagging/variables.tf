...
variable "domain" {
  ...
  validation {
    condition = contains([
      ...
      "forma.ffreis.com",
      "editify.ffreis.com",
      "flowgraph.ffreis.com",
      "internal",
    ], var.domain)
    error_message = "domain must be one of: flemming.com.br, ffreis.com, petlook.ai, petlook.app, dashboard.ffreis.com, uxstoryteller.ffreis.com, pocketworldarcade.ffreis.com, pocketworldarcade.app, urbs.ffreis.com, media.ffreis.com, forma.ffreis.com, editify.ffreis.com, flowgraph.ffreis.com, internal."
  }
}
